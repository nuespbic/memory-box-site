    ...
    <LegalPageLayout title="利用規約" updatedAt={LEGAL_UPDATED_AT}>
      ...
      <LegalSection title="第2条（サービス内容）">
        <p>
          ...
          Memory Box は、ユーザーに事前の通知なく、本サービスの内容を変更、追加、または停止することがあります。
        </p>
      </LegalSection>
      ...
      <LegalSection title="第3条（アカウントおよびデータ）">
        <p>
          ...
          Memory Box は、ユーザーのデータを第三者に販売しません。
        </p>
      </LegalSection>
      ...
      <LegalSection title="第4条（禁止事項）">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>Memory Box または第三者の権利を侵害する行為</li>
          <li>本サービスの運営を妨害する行為</li>
          <li>不正アクセス、リバースエンジニアリング等の行為</li>
          <li>その他、Memory Box が不適切と判断する行為</li>
        </ul>
      </LegalSection>

      <LegalSection title="第5条（免責事項）">
        <p>
          Memory Box は、本サービスがユーザーの特定の目的に適合すること、期待する成果を実現すること、
          および不具合が生じないことを保証するものではありません。
          本サービスの利用により生じた損害について、Memory Box
          に故意または重過失がある場合を除き、Memory Box は責任を負いません。
        </p>
      </LegalSection>

      <LegalSection title="第6条（サービスの変更・終了）">
        <p>
          Memory Box は、メンテナンス、障害対応、機能改善その他の理由により、
      ...
      <LegalSection title="第7条（規約の変更）">
        <p>
          Memory Box は、必要に応じて本規約を変更することがあります。
